...
function cargar_materias() {
	$.post("materias/cargar",{},function(respuesta) {
		...
		$.each(respuesta,function(i,j) {
			...
			tr.append('<td><button id="'+j.clave_materia+'" class="btnImg btn btn-danger"><img src="assets/img/eliminar.png"></button>' )
			tr.appendTo($('tbody'));

			$("#"+j.clave_materia).click(function(e) {
				$.post("materias/eliminar",{clave:j.clave_materia},function(respuesta) {
