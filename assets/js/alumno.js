...
function cargar_alumnos() {
	$.post("alumnos/cargar",function(respuesta) {
		...
		$.each(respuesta,function(i,j) {
			...
			tr.append('<td><button id="'+j.matricula+'" class="btnImg btn btn-danger"><img src="assets/img/eliminar.png"></button>' )
			tr.appendTo($('tbody'));

			$("#"+j.matricula).click(function(e) {
				$.post("alumnos/eliminar",{matricula:j.matricula},function(respuesta) {
